...
userGoodsDap.prototype.add = function(params, callback) {
    try {
        validator.has(params, ['userId', 'imagePath', 'title', 'price', 'description', 'brandId', 'bagTypeId']);
...
userGoodsDap.prototype.getListByLimitAndUpdateDatetime = function(params, callback) {
    try {
        validator.has(params, ['limit', 'updateDatetime']);
        validator.unsignedInteger(params.limit);
