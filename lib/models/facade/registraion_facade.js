 ...
 * @class 事前登録Facade
 */
var RegistraionFacade = function() {
};
util.inherits(RegistraionFacade, BaseFacade);
 ...
 *     result: 投稿データ
 */
RegistraionFacade.prototype.index = function(params, callback) {
    try {
...
var facade = new RegistraionFacade();
facade.init();
