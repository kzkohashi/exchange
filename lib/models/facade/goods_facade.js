 ...
 * @class GoodsFacade
 */
var GoodsFacade = function() {
};
util.inherits(GoodsFacade, BaseFacade);
 ...
 *     result: 投稿データ
 */
GoodsFacade.prototype.index = function(params, callback) {
    try {
 ...
 *     result: 投稿データ
 */
GoodsFacade.prototype.comment = function(params, callback) {
    try {
